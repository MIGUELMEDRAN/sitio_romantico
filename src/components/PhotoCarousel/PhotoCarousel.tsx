...
export default function PhotoCarousel() {
  ...
  return (
    <section className="container mx-auto px-6 py-16">
      <h2 className="text-3xl font-semibold mb-12 text-center">Galería de Momentos</h2>
                ...
                <div className="bg-white rounded-2xl shadow-2xl overflow-hidden hover:shadow-3xl transition-shadow duration-300">
                  ...
                  <div className="p-6 md:p-8">
                    ...
                    <p className="text-gray-600 mb-6 leading-relaxed">
                      Un momento especial capturado en el tiempo. Esta foto representa los hermosos recuerdos que compartimos juntos.
                    </p>
